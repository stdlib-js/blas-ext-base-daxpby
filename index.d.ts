...
interface Routine {
	...
	*/
	( N: number, alpha: number, x: Float64Array, strideX: number, beta: number, y: Float64Array, strideY: number ): Float64Array;
	...
	* // y => <Float64Array>[ 9.0, 16.0, 23.0, 30.0, 37.0 ]
	*/
	ndarray( N: number, alpha: number, x: Float64Array, strideX: number, offsetX: number, beta: number, y: Float64Array, strideY: number, offsetY: number ): Float64Array;
}
